...
### Goal Progress
First bug has officially been submitted! Write up coming soon but it was a hella basic XSS injection into SeekingAlpha.com to force a JS popup alert
...
|**Name**|**Description**|
|:----:|:-----------:|
|[DanielMiessler - SecLists](https://github.com/danielmiessler/SecLists)| Github Repo for SecLists files|
|[1N3 - IntruderPayloads](https://github.com/1N3/IntruderPayloads)| Github Repo for a variety of Payloads check this out more|
...
|[Kaspersky](https://www.youtube.com/user/Kaspersky)||
|[Metasploit](https://www.youtube.com/channel/UCx4d2aRIfxfEUdS_5YIYKPg)||
|[Ntop](https://www.youtube.com/channel/UCUYWuYlYKD5Yq5qBz0AIXJw)||
...
|[SocialEngineerOrg](https://www.youtube.com/user/SocialEngineerOrg)||
|[Sonatype](https://www.youtube.com/user/sonatype)||
|[Sophos](https://www.youtube.com/user/SophosLabs)||
...
|[BruCON](https://www.youtube.com/channel/UCqwMU1l90lf9BLersW6eAHw)||
|[BSides Manchester](https://www.youtube.com/channel/UC1mLiimOTqZFK98VwM8Ke4w)||
|[BSides Augusta](https://www.youtube.com/channel/UC85CvsnrVlD_44eEgzb2OfA)||
|[CarolinaCON](https://www.youtube.com/channel/UCTY3Dpz68CyrjwRzqkE4sFw)||
|[CortJohnson](https://www.youtube.com/channel/UCV9r-yMeARWVCJEesim25Ag)||
...
|[Garage4Hackers](https://www.youtube.com/channel/UCDqagqREZlmJitWco-yPtvw)||
|[HackADay](https://www.youtube.com/channel/UCnv0gfLQFNGPJ5MHSGuIAkw)||
|[HackInTheBox](https://www.youtube.com/channel/UC0BJVNTIEbG8CLG-xVVWJnA)||
|[HackInParis](https://www.youtube.com/channel/UC7xJU9_oqw-vS6OJExS-2iA)||
|[Cooper](https://www.youtube.com/channel/UCI6B0zYvK-7FdM0Vgh3v3Tg)||
|[Hacktivity](https://www.youtube.com/user/hacktivity)||
|[Hardwear.io](https://www.youtube.com/channel/UChwYb9xc9tZXquQxu4G0l_g)||
|[IEEE](https://www.youtube.com/channel/UC6pXMS7qre9GZW7A7FVM90Q)||
...
|[SJSU Infosec](https://www.youtube.com/channel/UCDNzNvZlYK8jZLsUbdiGrsQ)||
...
|[SecurityTubeCON](https://www.youtube.com/channel/UC2wNN-Zqiq4J1PLPnyMBWUg)||
|[ToorCON](https://www.youtube.com/channel/UCnzjmL0xkTBYwFZD7agHGWw)||
|[USENIX Enigma](https://www.youtube.com/channel/UCIdV7bE97mSPTH1mOi_yUrw)||
|**News**|**Channels**|
|:----:|:-----------:|
|[0x41414141](https://www.youtube.com/channel/UCPqes566OZ3G_fjxL6BngRQ)||
|[IronGeek (Adrian Crenshaw)](https://www.youtube.com/user/irongeek/videos)||
|[Danooct1](https://www.youtube.com/user/danooct1)||
|[DemmSec](https://www.youtube.com/user/DemmSec)||
|[Derek Rook](https://www.youtube.com/channel/UCMACXuWd2w6_IEGog744UaA/videos)||
|[DonDoes30](https://www.youtube.com/channel/UCarxjDjSYsIf50Jm73V1D7g/videos)||
...
|[SecureNinjaTV](https://www.youtube.com/user/Secureninja/videos)||
...
|**Name**|**Description**|
|:----:|:-----------:|
|[/r/Hacking](https://www.reddit.com/r/hacking)|Skiddies Galore|
|[/r/HowToHack](https://www.reddit.com/r/howtohack)|Skiddies Galore|
|[/r/InfoSec](https://www.reddit.com/r/infosec)||
|[r/LiveOverflow](https://www.reddit.com/r/liveoverflow)|Sub-reddit for the bomb-ass YT channel, LiveOverflow|
...
|**Name**|**Description**|
|:----:|:-----------:|
|[Fat List of CTF Websites](http://captf.com/practice-ctf)||
|[PicoCTFs](https://2018game.picoctf.com)||
|[hacker101CTFs](https://ctf.hacker101.com/ctf)|Official CTF page for Hacker101|
|[CTF Time](https://ctftime.org)|CTF Event Tracker/Calendar|
|[CTF Learn](https://ctflearn.com/problems)|Easier/Beginner CTF Problems|
|[Backdoor](https://backdoor.sdslabs.co)|PenTesting labs with beginner space, practice arena, various competitions, account required|
|[Cryptopals](https://cryptopals.com)|Challenges focused on Cryptography|
|[ChallengeLand](http://challengeland.co)|CTFs|
|[Crackme](https://crackmes.one)|Download crackmes to improve reverse engineering skills|
|[CTF Writeups (Github)](https://github.com/ctfs)|CTF Writeups|
|[CTF365](https://ctf365.com)|CTFs awarded by Kaspersky, MIT, T-Mobile|
|[The Enigma Group](https://www.enigmagroup.org)|Web application security training, account based, video tutorials|
|[Google CTF](https://capturetheflag.withgoogle.com)|CTF held by Google|
|[Google XSS Game](https://xss-game.appspot.com)|XSS Challenges|
|[HackTheBox](https://www.hackthebox.eu/login)|Pen testing labs with two new boxes every month|
|[HackerTest](http://www.hackertest.net)|Similar to HackThisSite|
|[HackerGateway](https://www.hackergateway.com)|CTFs on steganography, cryptography, and web challengs|
|[HackSplaining](https://www.hacksplaining.com)|Clickthrough security informational site, good for beginners|
|[Hack.Me](https://hack.me)|Build/Host/Attack vulnerable web apps|
|[HackThisSite](https://www.hackthissite.org)|Old but loved in the community|
|[Lin.Security](https://in.security/lin-security-practise-your-linux-privilege-escalation-foo)|Practice Linux Privilege Escalations|
|[OverTheWire (WarGames)](http://overthewire.org/wargames)|CTF labs with progressive levels, users SSH in|
|[SecurityShepherd (OWASP)](https://security-shepherd.ctf365.com/login.jsp)||
|[WeChall](http://www.wechall.net/active_sites/all/by/site_avg/DESC/page-1)|Universial ranking for CTF participants|
|[PenTesterLab](https://pentesterlab.com)|Variety of exercises & subject-focused bootcamps|
|[PenTestIt](https://lab.pentestit.ru)|CTFs where users need open VPN and credentials|
|[PenTestPractice](https://www.pentestpractice.com)|PenTesting Practice with Freemium options|
|[Pwnable.Kr](http://pwnable.kr)|CTFs|
|[Pwnable.Tw](https://pwnable.tw)|CTFs w/ Writeups|
|[Ringer0 CTF](https://ringzer0ctf.com/challenges)|CTFs|
|[ROP Emporium](https://ropemporium.com)|Return Oriented Programming Challenges|
|[SmashTheStack (WarGames)](http://smashthestack.org/wargames.html)|SSH into the machines and solve|
|[ShellterLabs](https://shellterlabs.com/en)|Social/Community InfoSec Labs/Challenges|
|[VulnHub](https://www.vulnhub.com)|Tons of different vulnerable VMs|
|[WebSec.Fr](https://websec.fr)|Web challenges|
|[SterotypedChallenges](https://chall.stypr.com)|Web security challenges|
...
|[Mind Maps](https://www.amanhardikar.com/mindmaps.html)|Mind Maps relating to Information Security|
|[White Hat Academy]()|s|
